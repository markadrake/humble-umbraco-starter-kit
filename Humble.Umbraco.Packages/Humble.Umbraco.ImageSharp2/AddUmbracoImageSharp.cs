...
namespace Humble.Umbraco.ImageSharp2
{
    public static partial class UmbracoBuilderExtensions
    {
        ...
        /// </summary>
        public static IServiceCollection AddUmbracoImageSharp2(this IUmbracoBuilder builder)
        {
            ImagingSettings imagingSettings = builder.Config.GetSection(Constants.Configuration.ConfigImaging)
